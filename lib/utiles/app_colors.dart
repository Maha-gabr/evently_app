...
class AppColors {
  static final Color whiteBgColor = Color(0xffF4F7FF);
  static final Color primaryDarkColor =Color(0xff000F30);
  static final Color blackColor =Color(0xff1C1C1C);
  static final Color whiteColor =Color(0xffFFFFFF);
  static final Color whiteDarkColor =Color(0xFFD6D6D6);
  static final Color greyColor =Color(0xFF686868);
